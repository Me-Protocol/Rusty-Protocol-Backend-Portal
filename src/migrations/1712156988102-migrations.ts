...
export class Migrations1712156988102 implements MigrationInterface {
    name = 'Migrations1712156988102'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "coupon" ADD "orderCode" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "coupon" DROP COLUMN "orderCode"`);
    }
