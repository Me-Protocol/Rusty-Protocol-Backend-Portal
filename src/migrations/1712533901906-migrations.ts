...
export class Migrations1712533901906 implements MigrationInterface {
    name = 'Migrations1712533901906'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "coupon" RENAME COLUMN "orderCode" TO "order_code"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "coupon" RENAME COLUMN "order_code" TO "orderCode"`);
    }
